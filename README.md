...
(`notebooks/05_analise_logistica_sla.ipynb`). A redação do relatório
executivo, a apresentação e o vídeo para os investidores são entregáveis à
parte, não incluídos neste repositório.
